...
- `URLListWidget`: Widget for managing URL list
...
**Purpose:** Embedded icon resources
**Responsibilities:**
- Provide green, orange, red icon data
- Embed icons at compile time
- Support multiple icon formats per platform
